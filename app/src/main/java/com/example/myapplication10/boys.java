...
public class boys extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    double[] latitude ={9.882623,9.881888,9.882239,9.882271,9.883402,9.882765,9.882733};
    double[] longitude={78.083606,78.082615,78.082337,78.081639,78.079753,78.083133,78.083882};
    public double j=0;
    public double k=0;
    public double e=0;
    public double f=0;
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(boys.this);
...
// Call this method with Context from within an Activity
                        NavigationLauncher.startNavigation(boys.this, options);
                    }
                });
            }
        });
...
// Set the component's camera mode
    ...
    public void onBackPressed() {
        Intent I = new Intent(boys.this, MainActivity.class);
        startActivity(I);
        finish();
    }
}
