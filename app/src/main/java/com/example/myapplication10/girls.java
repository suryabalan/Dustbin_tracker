...
public class girls extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    double[] latitude ={9.882605,9.882015,9.881888,9.882239,9.883405,9.882765,9.882740};
    double[] longitude={78.083876,78.083578,78.082615,78.082337,78.079831,78.083133,78.083693};
    public double j=0;
    public double k=0;
    public double e=0;
    public double f=0;
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                final Marker m1 = mapboxMap.addMarker(new MarkerOptions()
                        .position(new LatLng(9.882605, 78.083876)));
                final Marker m2 = mapboxMap.addMarker(new MarkerOptions()
                        .position(new LatLng(9.882015, 78.083578)));
                ...
                final Marker m5 = mapboxMap.addMarker(new MarkerOptions()
                        .position(new LatLng(9.883405, 78.079831)));
                ...
                final Marker m7 = mapboxMap.addMarker(new MarkerOptions()
                        .position(new LatLng(9.882740, 78.083693)));
                ...
                mapboxMap.addOnMapClickListener(girls.this);
...
// Call this method with Context from within an Activity
                        NavigationLauncher.startNavigation(girls.this, options);
                    }
                });
            }
        });
